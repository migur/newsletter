...
Raphael.fn.g.piechart = function (cx, cy, r, values, opts) {
    ...
    if (len == 1) {
        ...
        function sector(cx, cy, r, startAngle, endAngle, fill) {
            ...
            var corStartAngle = startAngle, corEndAngle = endAngle;

            if (startAngle < 0  ) corStartAngle = startAngle + 360;
            if (startAngle > 360) corStartAngle = startAngle - 360;

            if (endAngle < 0 ) corEndAngle = endAngle + 360;
            if (endAngle >360) corEndAngle = endAngle - 360;

			// handle the 380degrees arc
            if (corStartAngle == corEndAngle) {
                endAngle +=2;
            }
