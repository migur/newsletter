...
class NewsletterClassExtensionAdapterPlugin extends JAdapterInstance
{
	...
	public function loadLanguage($path = null)
	{
		...
		if (!$source)
		{
			$this->parent
				->setPath(
				'source',
				JPATH_COMPONENT_ADMINISTRATOR . DIRECTORY_SEPARATOR . 'extensions' . DIRECTORY_SEPARATOR . 'plugins' . DIRECTORY_SEPARATOR . $this->parent->extension->extension
			);
		}
		...
		if ($this->manifest->files)
		{
			...
			if (count($element->children()))
			{
				foreach ($element->children() as $file)
				{
					...
					{
						$extension = strtolower((string) $file->attributes()->plugin);
						break;
					}
				}
			}
			...
			if ($extension)
			{
				...
				$source = $path ? $path : JPATH_COMPONENT_ADMINISTRATOR . DIRECTORY_SEPARATOR . 'extensions' . DIRECTORY_SEPARATOR . 'plugins' . DIRECTORY_SEPARATOR . $extension;
	...
	public function install()
	{
		...
		if (!empty($element))
		{
			$this->parent->setPath('extension_root', $basePath  . DIRECTORY_SEPARATOR . 'extensions' . DIRECTORY_SEPARATOR . 'plugins' . DIRECTORY_SEPARATOR . $element);
		}
		else
		{
...
//		}
	...
	public function uninstall($id)
	{
		...
		$this->parent->setPath(
			...
			'plugins' . DIRECTORY_SEPARATOR . $element
		);
