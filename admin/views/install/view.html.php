...
class NewsletterViewInstall extends MigurView
{
	...
	protected function addToolbar()
	{
		...
		$bar->appendButton('Migurstandard', 'trash', 'JTOOLBAR_DELETE', 'install.remove', false);
		$bar->appendButton('Migurstandard', 'refresh', 'COM_NEWSLETTER_RESTORE', 'install.restore', false);
...
//		$bar->appendButton('Migurstandard', 'publish', 'JTOOLBAR_ENABLE', 'install.publish', false);
		$bar->appendButton('Migurhelp', 'question-sign', 'COM_NEWSLETTER_HELP', NewsletterHelperSupport::getResourceUrl('extensions/manager'));
