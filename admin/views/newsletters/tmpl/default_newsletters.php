		...
		<table id="container-newsletters" class="adminlist  table table-striped pull-left" width="100%">
			<thead>
				<tr>
					...
					<th class="column-narrow left">
						<?php echo JHtml::_('grid.sort', 'COM_NEWSLETTER_SENT_TO', 'sent_to', $this->listDirn, $this->listOrder); ?>
					</th>
					<th class="column-date left">
						<?php echo JHtml::_('grid.sort', 'COM_NEWSLETTER_START_DATE', 'n.sent_started', $this->listDirn, $this->listOrder); ?>
					</th>
				</tr>
			</thead>
			<tfoot>
