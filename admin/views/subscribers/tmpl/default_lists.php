			...
			<div id="lists-filter-panel" class="row-fluid filter-panel"  data-role="panel-container">
				...
				<div class="filter-panel-inner" data-role="panel-container-inner">
					...
					<div class="btn-group pull-left">
						...
						<button rel="tooltip" onclick="document.id('lists_filter_search').value='';this.form.submit(); return false;" type="button" class="btn tip btn-danger" data-original-title="<?php echo JText::_('JSEARCH_FILTER_CLEAR'); ?>"><i class="icon-remove"></i></button>
					</div>
