<div id="tab-container-dimensions">
	...
	<div id="dimensions1">
		<legend><?php echo JText::_('COM_NEWSLETTER_COLUMN') . ' 1'; ?></legend>
		<?php 
	...
	<div id="dimensions2">
		<legend><?php echo JText::_('COM_NEWSLETTER_COLUMN') . ' 2'; ?></legend>
		<?php 
	...
	<div id="dimensions3">
		<legend><?php echo JText::_('COM_NEWSLETTER_COLUMN') . ' 3'; ?></legend>
		<?php 
