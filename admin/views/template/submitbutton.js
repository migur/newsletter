/**
 * The main submit functionality for forms in template view.
 *
 * @version	   $Id:  $
...
Joomla.submitbutton = function(task, form)
{
	...
	else
	{
		...
		if (action[1] != 'cancel' && action[1] != 'close')
		{
            ...
            Migur.validator.sliderIndicator(
                '#slider-template',
                'h3 a',
                'tab-invalid',
                '.invalid'
		...
		if (isValid)
		{
			Joomla.submitform(task, document.templateForm);
			return true;
		}
		else
		{
