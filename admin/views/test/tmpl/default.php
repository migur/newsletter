...
<table class="templateslist adminlist  table table-striped" width="100%">
	...
	<tbody>
		...
		<tr class="row1">
			<td><a class="test-title" href="#" onClick="">Confirm subscribers for List</a></td>
			<td><select class="test-method"><option selected value="get">GET</option><option value="post">POST</option></td>
			<td><input class="test-url" value="<?php echo 'administrator/index.php?option=com_newsletter&task=test.confirmSubscribers'; ?>" size="60"/></td>
