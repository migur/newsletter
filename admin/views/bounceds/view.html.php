...
class NewsletterViewBounceds extends MigurView
{
	...
	public function display($tpl = null)
	{
		...
		NewsletterHelperView::addStyleSheet('media/com_newsletter/css/bounceds.css');
		...
		NewsletterHelperView::addScript('administrator/components/com_newsletter/views/newsletters/bounceds.js');
