...
/**
 * The media helper. The Joomla Media Helper adopted for Newsletter component
 *
 * @version	   $Id:  $
...
abstract class MediaHelper
{
	...
	public static function canUpload($file, &$err)
	{
		...
		//$params->set('file_path', 'images');
		//$params->set('image_path', 'images');
		$params->set('restrict_uploads', '1');
		$params->set('check_mime', '1');
		$params->set('image_extensions', 'bmp,gif,jpg,png');
		$params->set('ignore_extensions', '');
		$params->set('upload_mime_illegal', 'image/jpeg,image/gif,image/png,image/bmp,application/x-shockwave-flash,application/msword,application/excel,application/pdf,application/powerpoint,text/plain,application/x-zip');
		$params->set('upload_mime', 'text/html');
		//$params->set('enable_flash', '0');
	...
	/**
	 * Counts files in the selected directory
	 *
	 * @param string Directory
	 *
	 * @return array - count of files and dirs
	 * @since 1.0
	 * @author Joomla team
	 */
